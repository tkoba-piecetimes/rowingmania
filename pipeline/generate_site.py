...
SITE_BASE = "https://tkoba-piecetimes.github.io/rowingmania/"
GA_MEASUREMENT_ID = ""
GSC_VERIFICATION = ""
...
STYLE = """
:root {
  --ink:#182228; --sub:#5a6b74; --line:#dbe4e8; --bg:#f4f8fa; --surface:#fff;
  --navy:#0b2e4a; --navy-2:#124a73; --accent:#0891b2; --accent-dark:#0e7490;
...
.header-inner { max-width:980px; margin:0 auto; padding:.7rem 1rem .5rem;
...
.brand-sub { font-size:.6rem; color:#9fc6d6; font-weight:600; letter-spacing:.18em; }
.global-nav { display:flex; gap:.2rem; overflow-x:auto; margin-left:auto; }
.global-nav a { color:#d3e6ec; text-decoration:none; font-size:.85rem; font-weight:600;
...
.league-nav-inner { max-width:980px; margin:0 auto; padding:.3rem 1rem;
...
.league-nav a { color:#d3e6ec; text-decoration:none; font-size:.8rem;
  padding:.3em .6em; border-radius:6px; white-space:nowrap; margin-left:auto; }
.league-nav a:hover { background:var(--navy); color:#fff; }

.hero { background:linear-gradient(120deg, var(--navy) 0%, var(--navy-2) 70%, #0f6a86 100%);
  color:#fff; margin:0 -1rem; }
.hero-inner { max-width:980px; margin:0 auto; padding:2.2rem 1rem 2.4rem; }
...
.hero-sub { color:#c3dbe4; font-size:.85rem; margin:0; }
...
tbody tr:nth-child(even) { background:#eef5f7; }
...
.cat { background:#e2eff2; color:var(--navy-2); font-size:.72rem; font-weight:700;
...
.site-footer { background:var(--navy); color:#9fc6d6; font-size:.75rem;
  margin-top:3rem; }
.footer-inner { max-width:980px; margin:0 auto; padding:1.4rem 1rem 2rem; }
...
.footer-nav a { color:#c3dbe4; text-decoration:none; }
.site-footer a { color:#c3dbe4; }
"""
